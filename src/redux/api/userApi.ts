...
export const { useGetProfileQuery, useGetUserProfileQuery, useUpdateProfileMutation, useUnfollowUserMutation, useGetAllUserQuery, useDeleteUserMutation, usePromoteUserMutation, useFollowUserMutation } = userApi;
